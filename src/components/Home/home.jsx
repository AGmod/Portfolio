  ...
  return (
    ...
    <section id='home'>
      ...
      <div className='homeContent'>
        ...
        {/* Quick description */}
        <p className='description'>I am a graduate from Cal State University Fullerton <br/> and I have worked on various projects throughout my years of learning</p>
      </div>
